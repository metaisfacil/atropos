...
export function LoadImageFromClipboard():Promise<main.ImageInfo>;
...
export function SkipCrop():Promise<main.ProcessResult>;
...
export function TouchUpApplyStrokes(arg1:main.TouchUpStrokeRequest):Promise<main.ProcessResult>;
