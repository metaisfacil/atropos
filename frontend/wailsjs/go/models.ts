...
export namespace main {
	...
	export class CalibrationEntryRequest {
	    imagePath: string;
	    width: number;
	    height: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new CalibrationEntryRequest(source);
	    }
	    ...
	    constructor(source: any = {}) {
	        ...
	        this.corners = this.convertValues(source["corners"], CalibrationPoint);
	    }
	...
	export class CalibrationImageInfo {
	    imagePath: string;
	    preview: string;
	    width: number;
	    height: number;
	    ...
	    static createFrom(source: any = {}) {
	        return new CalibrationImageInfo(source);
	    }
	...
	export class CalibrationLoadRequest {
	    filePath: string;
	
	    static createFrom(source: any = {}) {
	        return new CalibrationLoadRequest(source);
	    }
	...
	export class CalibrationSaveRequest {
	    entries: CalibrationEntryRequest[];
	
	    static createFrom(source: any = {}) {
	        return new CalibrationSaveRequest(source);
	    }
	
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.entries = this.convertValues(source["entries"], CalibrationEntryRequest);
	    }
	...
	export class CalibrationSaveResult {
	    outputPath: string;
	    count: number;
	    cancelled?: boolean;
	
	    static createFrom(source: any = {}) {
	        return new CalibrationSaveResult(source);
	    }
	...
	export class TouchUpPoint {
	    x: number;
	    y: number;
	
	    static createFrom(source: any = {}) {
	        return new TouchUpPoint(source);
	    }
	...
	export class TouchUpStrokeRequest {
	    points: TouchUpPoint[];
	    brushSize: number;
	    patchSize: number;
	    iterations: number;
	    ...
	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.points = this.convertValues(source["points"], TouchUpPoint);
